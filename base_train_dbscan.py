...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('-dt', '--dataset-source', type=str, default='market1501',
                        choices=datasets.names()) # dukemtmc
    parser.add_argument('-ds', '--dataset-target', type=str, default='market1501',
    ...
    # training configs
    parser.add_argument('--init', type=str, default='logs/pretrained/resnet50_ibn_a.pth.tar', metavar='PATH')
